...
class PartialConv2d(nn.Conv2d):
    ...
    def forward(self, input: Tensor, mask_in: Tensor) -> Union[Tuple[Tensor, Tensor], Tensor]:
        with torch.no_grad():
            ...
            sum = F.conv2d(mask_in, self.mask_one, stride = self.stride, padding = self.padding, dilation = self.dilation)
...
class PartialConv3d(nn.Conv3d):
    ...
    def forward(self, input: Tensor, mask_in: Tensor) -> Union[Tuple[Tensor, Tensor], Tensor]:
        ...
        with torch.no_grad():
            ...
            sum = F.conv3d(mask_in, self.mask_one, stride = self.stride, padding = self.padding, dilation = self.dilation)
...
class PartialConv1d(nn.Conv1d):
    ...
    def forward(self, input: Tensor, mask_in: Tensor) -> Union[Tuple[Tensor, Tensor], Tensor]:
        ...
        with torch.no_grad():
            ...
            sum = F.conv1d(mask_in, self.mask_one, stride = self.stride, padding = self.padding, dilation = self.dilation)
