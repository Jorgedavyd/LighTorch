...
class _DefaultFFN(nn.Module):
    def __init__(self, in_features: int, k_multiplier: int, out_features: int, activation: Callable[[Tensor], Tensor]) -> None:
        super().__init__()
...
class _GLU(nn.Module):
    def __init__(self, in_features: int, out_features: int, activation: Callable[[Tensor], Tensor]) -> None:
        super().__init__()
...
class BiGLU(_GLU):
    def __init__(
        ...
        super().__init__(
            in_features, out_features, nn.Identity()
        )
