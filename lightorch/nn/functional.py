...
def _fourierdeconvNd(x: Tensor, weight: Tensor, bias: Tensor | None, eps: float = 1e-5) -> Tensor:
    # weight -> 1, 1, out channels, *kernel_size
...
def fourierconv3d(x: Tensor, one: Tensor, weight: Tensor, bias: Tensor | None):
    ...
    out = rearrange(out, 'B C (f kd) (h kh) (w kw) -> B (f h w) C kd kh kw', kd=weight.shape[-3], kh=weight.shape[-2], kw=weight.shape[-1])
...
def fourierconv2d(x: Tensor, one: Tensor, weight: Tensor, bias: Tensor | None):
    ...
    out = rearrange(out, 'B C (h k1) (w k2) -> B (h w) C k1 k2', k1 = weight.shape[-2], k2 = weight.shape[-1])
...
def fourierdeconv3d(x: Tensor, one: Tensor, weight: Tensor, bias: Tensor | None, eps: float = 1e-5):
    """
    x (Tensor): batch size, channels, height, width
    weight (Tensor): out channels, *kernel_size
    one (Tensor): out channels, in channels, *1 #Paralelization game
...
def fourierdeconv2d(x: Tensor, one: Tensor, weight: Tensor, bias: Tensor | None, eps: float = 1e-5):
    """
    x (Tensor): batch size, channels, height, width
    weight (Tensor): out channels, *kernel_size
    one (Tensor): out channels, in channels, *1 #Paralelization game
...
def fourierdeconv1d(x: Tensor, one: Tensor, weight: Tensor, bias: Tensor | None, eps: float = 1e-5):
    """
    x (Tensor): batch size, channels, sequence length
    weight (Tensor): out channels, kernel_size
    one (Tensor): out channels, in channels, *1 #Paralelization game
...
def partialconv3d(
    ...
    return _partialconvnd(F.conv3d, input, mask_in, weight, one_sum, bias, stride, padding, dilation, update_mask)
...
def partialconv2d(
    ...
    return _partialconvnd(F.conv2d, input, mask_in, weight, one_sum, bias, stride, padding, dilation, update_mask)
...
def partialconv1d(
    ...
    return _partialconvnd(F.conv1d, input, mask_in, weight, one_sum, bias, stride, padding, dilation, update_mask)
